        ...
        <div className="relative text-center">
          ...
          <div className="relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[110px] overflow-hidden animate-spark">
            <svg
              ...
              className="w-[110px] h-[110px] fill-[#f00]"
            >
              <g>
          ...
          <div className="mt-3">
            <img
              ...
              className="h-[75px] animate-pulse-custom object-contain transform transition-none duration-200 ease-in-out scale-100 hover:scale-110"
            />
          </div>
        </div>
      </div>
